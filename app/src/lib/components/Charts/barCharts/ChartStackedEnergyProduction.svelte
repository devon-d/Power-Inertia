	...
	onMount( () => {
		...
		const renderChart = ( id: string ) => {
			...
			const trace1 = {
				...
				hovertemplate: "On <b>%{x}</b><br>Solar Generation (kWh)<b>%{y:.0f} kWh</b><extra></extra>"
			};
			...
			const trace2 = {
				...
				name: 'Battery System Discharge (kWh)',
				hovertemplate: "On <b>%{x}</b><br>Battery System Discharge (kWh)<b>%{y:.0f} kWh</b><extra></extra>"
			};
