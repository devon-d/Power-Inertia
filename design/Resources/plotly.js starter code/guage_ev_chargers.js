...
var maxText       =  "Est. Charging Capacity"
var guageColor    = "#3ABCDE"
var sampleResponse = {
...
var trace1 = {
    ...
    value: sampleResponse.ev_charger_load_kw,
    //         , font: { size: 16 } },
    gauge: {
      axis: { visible: false, 
             range: [0, sampleResponse.ev_charger_capacity_kw], 
     },
  ...
  annotations:[
    {
      ...
      y:.15,
      showarrow:false,
      text: maxText +"<br><b>" +  sampleResponse.ev_charger_capacity_kw + " kW</b>"
    }, 
  {
      xref:'paper',
      yref:'paper',
