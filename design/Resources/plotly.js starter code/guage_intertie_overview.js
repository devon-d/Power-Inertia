...
var trace1 = {
    ...
    type: "indicator",
    mode: "gauge",
    hoverinfo: sampleResponse.grid_imported_kw,
    plot_bgcolor: "rgba(0,0,0,0)",
    value: sampleResponse.grid_imported_kw,
    //         , font: { size: 16 } },
    gauge: {
      axis: { visible: false, 
             range: [0, sampleResponse.site_load_kw], 
     },
      ...
      steps:[
        {range:[0, sampleResponse.grid_imported_kw]
  ...
  annotations:[
    {
      ...
      y:.15,
      showarrow:false,
      text: maxText +"<br><b>" +  sampleResponse.site_load_kw + " kW</b>"
    }, 
  {
      xref:'paper',
      yref:'paper',
      ...
      y: 1.2, 
      showarrow:false,
      text: sampleResponse.grid_load_state + "<br><b>" + sampleResponse.grid_imported_kw + " kW</br>"
    ,  font: { size: 14 } }
  ]};
