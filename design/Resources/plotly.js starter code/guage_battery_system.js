...
// Battery System Gauge

var maxText       =  "Inverter Capacity"
var guageColor    = "#64B583"
var sampleResponse = {
...
var trace1 = {
    ...
    value: sampleResponse.inverter_power_kw,
    //         , font: { size: 16 } },
    gauge: {
      axis: { visible: false, 
             range: [0, sampleResponse.inverter_capacity_kw], 
     },
  ...
  annotations:[
    {
      ...
      y:.15,
      showarrow:false,
      text: maxText +"<br><b>" +  sampleResponse.inverter_capacity_kw + " kW</b>"
    }, 
  {
      xref:'paper',
      yref:'paper',
      ...
      y: 1.2, 
      showarrow:false,
      text: sampleResponse.inverter_state + "<br><b>" + sampleResponse.inverter_power_kw + " kW</br>"
    ,  font: { size: 14 } }
  ]};
